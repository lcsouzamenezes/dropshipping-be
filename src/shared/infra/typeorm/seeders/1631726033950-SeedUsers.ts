...
export class SeedUsers1631726033950 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO users (id, email, name, password, active, master, account_id) VALUES ('${this.user_id}', 'jonathan@lojasbertoldi.com.br', 'Jonathan Bertoldi', '${password}', '1', '1', '${this.account_id}')`
    )
  }
